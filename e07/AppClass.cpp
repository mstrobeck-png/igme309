...
void Application::Display(void)
{
	...
	*/
	...
	//\first use a vector3 for the three points (x,y,z) then you can assign it into a quaternion
	vector3 rotationalController = glm::degrees(m_v3Rotation);
	quaternion q_rotator(rotationalController);

	//now update the model to use the quaternion
	m_m4Model = ToMatrix4(q_rotator);
